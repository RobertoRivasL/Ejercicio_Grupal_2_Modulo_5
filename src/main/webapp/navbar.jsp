    ...
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a id="test" class="nav-link text-light" href="contacto.jsp">Contacto</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="svLogout">Log Out</a>
                    </li>
                    <div class="vr" style="width: 500px;"></div>
                    <li class="nav-item">
                        <h5 class="text-light">Bienvenid@: <%= session.getAttribute("username") %>
                        </h5>
                    </li>
                    <% } else { %>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="login.jsp">Log In</a>
                    </li>
                    <% } %>
                </ul>
            </div>
